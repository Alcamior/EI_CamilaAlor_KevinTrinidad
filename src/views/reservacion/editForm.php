...
?>
        ...
        <header class="row">
            <a class="col-md-4 col-sm-12" href="<?=asset_general('src/views/reservacion/consultaAdmin.php')?>"><i class="bi bi-arrow-left-circle"></i></a>
        ...
        <main class="row">
            <div class="formulario col-md-6 col-sm-12">
                ...
                <form method="POST" name="frmRes" id="frmRes" action="<?=asset_general('src/controllers/ReservacionController/edit.php') ?>">
                        ...
                        <select name="cliente" id="cliente">
                            <?php
                                foreach ($usuarios as $usuario) {
                                    $selected = ($usuario['idU'] == $idU) ? 'selected' : '';
                                    echo "<option value=\"{$usuario['idU']}\" $selected>{$usuario['nombre']} {$usuario['apellido']}</option>";
                                }
                            ?>
                        </select>
                    </div>     
                    ...
                    <div class="form_container">
                        ...
                        <br>
                        <input type="date" name="fecha" id="fecha" value="<?= isset($fecha) ? $fecha : '' ?>">
                        <br>
                    ...
                    <div class="form_container">
                        ...
                        <br>
                        <input type="time" name="horaIni" id="horaIni" value="<?= isset($horaIni) ? $horaIni : '' ?>">
                        <br>
                        ...
                        <select name="servicio" id="servicio">
                            <?php
                                foreach ($articulos as $articulo) {
                                    $selected = ($articulo['idS'] == $idS) ? 'selected' : '';
                                    echo "<option value=\"{$articulo['nombre']}\" $selected>{$articulo['nombre']}</option>";
                                }
                            ?>
                        </select>
                    </div> 
                    ...
                    <div class="form_container">
                        <label class="formulario_label">Elige el estatus</label>
                        <br>
